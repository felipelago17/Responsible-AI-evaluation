...
Announces the OECD’s monitoring framework for tracking organisational adoption of the Hiroshima Code of Conduct commitments at scale. The structured indicators inform the reporting schema used in `results/` versioned evaluation outputs, supporting longitudinal compliance tracking.
...
Multi-part standard establishing data quality requirements and measurement methodologies for AI training and evaluation datasets. Directly relevant to dataset provenance and versioning practices in `docs/governance.md` and the reproducibility guarantees of the evaluation harness.
...
The updated OECD AI Principles — the foundational international soft-law instrument for responsible AI, endorsed by 46+ countries. The five OECD principles map directly to the evaluation dimensions of this framework and provide the normative basis for `docs/governance_mapping.md`.
...
The UN High-Level Advisory Body’s report outlining an international governance architecture for AI, including proposals for a multistakeholder advisory body, capacity-building mechanisms, and inclusive global AI governance principles. Provides geopolitical context for interpreting evaluation results across jurisdictions.
...
UNESCO’s 2021 Recommendation on the Ethics of Artificial Intelligence — the first global normative instrument on AI ethics, adopted by all 193 member states — establishes values and principles covering human dignity, environmental sustainability, transparency, and accountability. The Recommendation’s emphasis on bias auditing and non-discrimination underpins the bias and toxicity evaluation dimensions.
...
A comparative analysis of major AI governance frameworks — EU AI Act, NIST AI RMF, ISO/IEC 42001, OECD Principles — highlighting convergence and divergence across risk classification, conformity assessment, and evaluation obligations. Supports the multi-framework alignment approach in `docs/governance_mapping.md`.
...
The primary U.S. voluntary framework for managing AI risks, structured around Govern, Map, Measure, and Manage. The Measure function — covering bias, robustness, and safety testing — maps directly to this framework’s evaluation dimensions and provides the risk categorisation taxonomy used in `docs/scoring.md`.

---

### NIST (2024) — Generative AI Profile: NIST AI 600-1

**Citation:** National Institute of Standards and Technology. (2024). *AI Risk Management Framework: Generative AI Profile*. NIST AI 600-1.  
**URL:** <https://doi.org/10.6028/NIST.AI.600-1>

An AI RMF profile addressing generative AI risks: hallucination, data privacy, bias amplification, malicious use, and autonomous agent risks. The 12 generative AI risk categories directly inform the benchmark selection and scoring rubrics for the truthfulness, red teaming, and agentic autonomy dimensions.

---

### Colorado General Assembly (2024) — Senate Bill 24-205

**Citation:** Colorado General Assembly. (2024). *Senate Bill 24-205: Consumer Protections in Interactions with Artificial Intelligence Systems*.  
**URL:** <https://leg.colorado.gov/bills/sb24-205>

The first U.S. state law imposing obligations on developers and deployers of high-risk AI systems, requiring algorithmic impact assessments, transparency notices, and anti-discrimination protections. A key U.S. state-level regulatory reference for the bias and governance evaluation dimensions.
...
The foundational EU document establishing seven requirements for trustworthy AI: human agency, technical robustness, privacy, transparency, non-discrimination, societal wellbeing, and accountability. The conceptual precursor to the EU AI Act; maps directly to the five evaluation dimensions of this framework.
...
Overview of the EU’s comprehensive AI policy ecosystem, encompassing the AI Act, AI Office, coordinated AI plan, and investment strategy. Provides institutional context for interpreting the EU AI Act’s conformity assessment requirements.
...
Documents the legislative history of the GDPR, which underpins data governance obligations applicable to AI systems processing personal data. Relevant to dataset provenance controls, retention policies, and privacy-by-design principles in `docs/governance.md`.
...
The DIFC’s AI regulatory regime governing entities in Dubai’s international financial free zone, covering explainability, accountability, bias mitigation, human oversight, and data governance for AI in financial services. A key sector-specific binding instrument for organisations subject to DIFC jurisdiction deploying high-stakes AI systems.
...
The TDRA is the UAE federal authority responsible for telecommunications regulation and digital government transformation, including oversight of AI adoption across government services. Its AI governance guidance covers responsible deployment principles, risk assessment obligations, and alignment with the UAE National AI Strategy 2031.
...
Smart Dubai’s ethical guidelines for AI deployment across government services and smart city infrastructure, covering transparency, fairness, accountability, privacy, and human oversight. Forms the emirate-level ethical baseline complementing the national UAE AI Strategy and the DIFC’s sector-specific obligations.

---

*See also: [Governance](../governance.md) and [Governance Mapping](../governance_mapping.md) for the framework’s internal governance documentation.*
